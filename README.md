...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-28 13:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/056401c1-d508-4a18-a7aa-ba4c01ec0f49.git
$ cd 056401c1-d508-4a18-a7aa-ba4c01ec0f49
```
